#ifndef PANOPTIC_MAPPING_TOOLS_MAP_EVALUATOR_H_
#define PANOPTIC_MAPPING_TOOLS_MAP_EVALUATOR_H_
...
class MapEvaluator {
 public:
  struct EvaluationRequest // actually the config
    ...
    // Evaluation
    float trunc_dist = 0.1;  // m
    float inlier_thre = 0.1;   // m, used for both mesh and tsdf accuracy evaluation
    bool visualize = true;
    bool evaluate = true;
...
#endif  // PANOPTIC_MAPPING_TOOLS_MAP_EVALUATOR_H_
